  ...
  <div class="container-xxl pt-3 flex-grow-1">
    ...
    <div class="container row mx-auto g-4 my-3 my-xl-5">
      <div class="col-12 col-md-6 col-xxl-6">
        <div class="row">
          <div class="col-6">           
            <div class="card d-flex flex-column rounded-4" style="height: 100%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#e8947c"></rect>
          ...
          <div class="col-6">
            <div class="card d-flex flex-column rounded-4" style="height: 38%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#802c24"></rect>
            ...
            <div class="card d-flex flex-column rounded-4" style="height: 58%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#b8b4b4"></rect>
        ...
        <div class="row">
          <div class="col-6">
            <div class="card d-flex flex-column rounded-4" style="height: 58%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#a89c64"></rect>
            ...
            <div class="card d-flex flex-column rounded-4" style="height: 38%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#e88434"></rect>
          ...
          <div class="col-6">
            <div class="card d-flex flex-column rounded-4" style="height: 100%;">
              <svg class="bd-placeholder-img card-img-top rounded-top-4" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false">
                <title>Placeholder</title>
                <rect width="100%" height="100%" fill="#e85444"></rect>
